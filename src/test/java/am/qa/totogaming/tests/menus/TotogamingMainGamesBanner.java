...
public class TotogamingMainGamesBanner extends TotogamingBaseTest {
	...
	public void testSportBanner() {
		...
		DriverUtil.waitForElementPresent(driver, 3, "//a[@id='mainSportBtn' and contains(@class, 'active')]");// div[contains(@class,
																												// 'home_page_left_panel')]
																												// miavorumy
	...
	public void testSportTournamentBanner() {
		...
		// irany chi DriverUtil.waitForElementPresent(driver, 3, "//a[@id='mainSportBtn'
		// and contains(@class, 'active')]");//div[contains(@class,
		// 'home_page_left_panel')]
